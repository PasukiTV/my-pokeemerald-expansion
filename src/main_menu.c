 ...
 * Task_NewGameBirchSpeech_StartBirchPichu_Spiky_EaredPlatformFade
 * Task_NewGameBirchSpeech_StartBirchPichu_Spiky_EaredPlatformFade
 ...
 * Task_NewGameBirchSpeech_ReshowBirchPichu_Spiky_Eared
 ...
 *  - Advances to Task_NewGameBirchSpeechSub_WaitForPichu_Spiky_Eared
 * Task_NewGameBirchSpeechSub_WaitForPichu_Spiky_Eared
...
static void Task_NewGameBirchSpeechSub_WaitForPichu_Spiky_Eared(u8);
static void Task_NewGameBirchSpeech_StartBirchPichu_Spiky_EaredPlatformFade(u8);
...
static void Task_NewGameBirchSpeech_ReshowBirchPichu_Spiky_Eared(u8);
...
#define tPichu_Spiky_EaredSpriteId data[9]
...
{
    u8 spriteId = gTasks[sBirchSpeechMainTaskId].tPichu_Spiky_EaredSpriteId;
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_PICHU_SPIKY_EARED);
    gTasks[taskId].func = Task_NewGameBirchSpeechSub_WaitForPichu_Spiky_Eared;
    gTasks[sBirchSpeechMainTaskId].tTimer = 0;
}

static void Task_NewGameBirchSpeechSub_WaitForPichu_Spiky_Eared(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    struct Sprite *sprite = &gSprites[gTasks[sBirchSpeechMainTaskId].tPichu_Spiky_EaredSpriteId];
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        ...
        AddTextPrinterForMessage(TRUE);
        gTasks[taskId].func = Task_NewGameBirchSpeech_StartBirchPichu_Spiky_EaredPlatformFade;
    }
}

static void Task_NewGameBirchSpeech_StartBirchPichu_Spiky_EaredPlatformFade(u8 taskId)
{
    if (!RunTextPrintersAndIsPrinter0Active())
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        gSprites[gTasks[taskId].tPichu_Spiky_EaredSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_StartPlayerFadeIn(u8 taskId)
{
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[gTasks[taskId].tPichu_Spiky_EaredSpriteId].invisible = TRUE;
        if (gTasks[taskId].tTimer)
        {
            gTasks[taskId].tTimer--;
        }
...
static void Task_NewGameBirchSpeech_StartNamingScreen(u8 taskId)
{
    ...
    {
        FreeAllWindowBuffers();
        FreeAndDestroyMonPicSprite(gTasks[taskId].tPichu_Spiky_EaredSpriteId);
...
static void Task_NewGameBirchSpeech_SlidePlatformAway2(u8 taskId)
{
    ...
    {
        gTasks[taskId].func = Task_NewGameBirchSpeech_ReshowBirchPichu_Spiky_Eared;
    }
}

static void Task_NewGameBirchSpeech_ReshowBirchPichu_Spiky_Eared(u8 taskId)
{
    u8 spriteId;
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
        spriteId = gTasks[taskId].tPichu_Spiky_EaredSpriteId;
        gSprites[spriteId].x = 100;
        gSprites[spriteId].y = 75;
        gSprites[spriteId].invisible = FALSE;
        gSprites[spriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static void Task_NewGameBirchSpeech_WaitForSpriteFadeInAndTextPrinter(u8 taskId)
{
    ...
    {
        gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        gSprites[gTasks[taskId].tPichu_Spiky_EaredSpriteId].oam.objMode = ST_OAM_OBJ_NORMAL;
        if (!RunTextPrintersAndIsPrinter0Active())
        {
            gSprites[gTasks[taskId].tBirchSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
            gSprites[gTasks[taskId].tPichu_Spiky_EaredSpriteId].oam.objMode = ST_OAM_OBJ_BLEND;
...
static u8 NewGameBirchSpeech_CreatePichu_Spiky_EaredSprite(u8 x, u8 y)
{
    return CreateMonPicSprite_Affine(SPECIES_PICHU_SPIKY_EARED, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}

static void AddBirchSpeechObjects(u8 taskId)
{
    u8 birchSpriteId;
    u8 pichu_spiky_earedSpriteId;
    u8 brendanSpriteId;
    u8 maySpriteId;
    ...
    pichu_spiky_earedSpriteId = NewGameBirchSpeech_CreatePichu_Spiky_EaredSprite(100, 0x4B);
    gSprites[pichu_spiky_earedSpriteId].callback = SpriteCB_Null;
    gSprites[pichu_spiky_earedSpriteId].oam.priority = 0;
    gSprites[pichu_spiky_earedSpriteId].invisible = TRUE;
    gTasks[taskId].tPichu_Spiky_EaredSpriteId = pichu_spiky_earedSpriteId;
...
#undef tPichu_Spiky_EaredSpriteId
