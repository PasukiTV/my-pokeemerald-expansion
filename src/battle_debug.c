...
// const rom data
static const u8 sText_Moves[] = _("Attacken");
static const u8 sText_Ability[] = _("Fähigkeit");
static const u8 sText_HeldItem[] = _("Getragenes Item");
static const u8 sText_HoldEffect[] = _("Item-Effekt");
static const u8 sText_PP[] = _("AP");
static const u8 sText_Types[] = _("Typen");
static const u8 sText_Stats[] = _("Statuswerte");
static const u8 sText_StatStages[] = _("Statusphasen");
...
static const u8 sText_SideStatus[] = _("Seiteneffekte");
static const u8 sText_AI[] = _("KI");
static const u8 sText_AIMovePts[] = _("KI Pkt./Schaden");
static const u8 sText_AiKnowledge[] = _("KI-Wissen");
static const u8 sText_AiParty[] = _("KI-Team");
static const u8 sText_Various[] = _("Verschiedenes");
static const u8 sText_CurrHp[] = _("Aktuelle KP");
static const u8 sText_MaxHp[] = _("Maximale KP");
...
static const u8 sText_SpAtk[] = _("Spez. Angriff");
static const u8 sText_SpDef[] = _("Spez. Verteid.");
static const u8 sText_Sleep[] = _("Schlaf");
static const u8 sText_Poison[] = _("Gift");
static const u8 sText_Burn[] = _("Verbrennung");
static const u8 sText_Freeze[] = _("Eis");
static const u8 sText_Paralysis[] = _("Paralyse");
static const u8 sText_ToxicPoison[] = _("Schweres Gift");
static const u8 sText_ToxicCounter[] = _("Giftzähler");
static const u8 sText_Frostbite[] = _("Erfrierung");
static const u8 sText_Confusion[] = _("Verwirrung");
static const u8 sText_Flinched[] = _("Zurückgeschreckt");
static const u8 sText_Uproar[] = _("Aufruhr");
static const u8 sText_Torment[] = _("Folterknecht");
static const u8 sText_Bide[] = _("Geduld");
static const u8 sText_LockConfuse[] = _("Wutanfall");
static const u8 sText_MultipleTurns[] = _("Mehrere Runden");
static const u8 sText_Wrapped[] = _("Umklammert");
static const u8 sText_Powder[] = _("Pulver");
static const u8 sText_Infatuation[] = _("Verliebt");
static const u8 sText_DefenseCurl[] = _("Einrollen");
static const u8 sText_Transformed[] = _("Verwandelt");
static const u8 sText_Recharge[] = _("Aufladen");
static const u8 sText_Rage[] = _("Zorn");
static const u8 sText_Substitute[] = _("Delegator");
static const u8 sText_DestinyBond[] = _("Abgesang");
static const u8 sText_EscapePrevention[] = _("Flucht verhindert");
static const u8 sText_Nightmare[] = _("Alptraum");
static const u8 sText_Cursed[] = _("Verflucht");
static const u8 sText_Foresight[] = _("Gesichte");
static const u8 sText_DragonCheer[] = _("Drachenruf");
static const u8 sText_FocusEnergy[] = _("Energie-Fokus");
static const u8 sText_LeechSeedHealer[] = _("Heilung durch Egelsamen");
static const u8 sText_LeechSeeded[] = _("Mit Egelsamen belegt");
static const u8 sText_AlwaysHits[] = _("Trifft immer");
static const u8 sText_PerishSong[] = _("Abgesang");
static const u8 sText_OnAir[] = _("In der Luft");
static const u8 sText_Underground[] = _("Unter der Erde");
static const u8 sText_Minimized[] = _("Verkleinert");
static const u8 sText_ChargedUp[] = _("Geladen");
static const u8 sText_Rooted[] = _("Gewurzelt");
static const u8 sText_Yawn[] = _("Gähner");
static const u8 sText_ImprisonedOthers[] = _("Versiegelung");
static const u8 sText_Grudge[] = _("Groll");
static const u8 sText_GastroAcid[] = _("Magenbremse");
static const u8 sText_Embargo[] = _("Embargo");
static const u8 sText_Underwater[] = _("Unter Wasser");
static const u8 sText_Trace[] = _("Spur");
static const u8 sText_SmackedDown[] = _("Herabgezogen");
static const u8 sText_MeFirst[] = _("Ich zuerst");
static const u8 sText_Telekinesis[] = _("Telekinese");
static const u8 sText_PhantomForce[] = _("Phantomkraft");
static const u8 sText_MiracleEyed[] = _("Wunderblick");
static const u8 sText_MagnetRise[] = _("Magnetflug");
static const u8 sText_HealBlock[] = _("Heilblockade");
static const u8 sText_AquaRing[] = _("Aquaring");
static const u8 sText_LaserFocus[] = _("Laserfokus");
static const u8 sText_PowerTrick[] = _("Krafttrick");
static const u8 sText_SkyDropped[] = _("Himmelsschlag");
static const u8 sText_Electrified[] = _("Elektrisiert");
static const u8 sText_MudSport[] = _("Lehmschelle");
static const u8 sText_WaterSport[] = _("Nassmacher");
static const u8 sText_InfiniteConfusion[] = _("Endlose Verwirrung");
static const u8 sText_SaltCure[] = _("Salzpanzer");
static const u8 sText_SyrupBomb[] = _("Sirupbombe");
static const u8 sText_GlaiveRush[] = _("Drachenstoß");
static const u8 sText_Reflect[] = _("Lichtschild");
static const u8 sText_LightScreen[] = _("Reflektor");
static const u8 sText_StickyWeb[] = _("Klebennetz");
static const u8 sText_Spikes[] = _("Stachler");
static const u8 sText_Safeguard[] = _("Bodyguard");
static const u8 sText_FutureAttack[] = _("Zukunftsattacke");
static const u8 sText_Mist[] = _("Nebelfeld");
static const u8 sText_Tailwind[] = _("Rückenwind");
static const u8 sText_AuroraVeil[] = _("Auroraschleier");
static const u8 sText_LuckyChant[] = _("Glücksgesang");
static const u8 sText_ToxicSpikes[] = _("Giftspitzen");
static const u8 sText_StealthRock[] = _("Tarnsteine");
static const u8 sText_Steelsurge[] = _("Stahlwoge");
static const u8 sText_DamageNonTypes[] = _("Schaden (ohne Typ)");
static const u8 sText_Rainbow[] = _("Regenbogen");
static const u8 sText_SeaOfFire[] = _("Flammenmeer");
static const u8 sText_Swamp[] = _("Morast");

static const u8 sText_CheckBadMove[] = _("Schlechte Attacke prüfen");
static const u8 sText_TryToFaint[] = _("Besiegen versuchen");
static const u8 sText_CheckViability[] = _("Nützlichkeit prüfen");
static const u8 sText_ForceSetupFirstTurn[] = _("Setup im ersten Zug erzwingen");
static const u8 sText_Risky[] = _("Riskant");
static const u8 sText_TryTo2HKO[] = _("Versuch: 2-Treffer-KO");
static const u8 sText_PreferBatonPass[] = _("Bevorzugt Stafette");
static const u8 sText_DoubleBattle[] = _("Doppelkampf");
static const u8 sText_HpAware[] = _("KP-Awareness");
static const u8 sText_PowerfulStatus[] = _("Starker Status");
static const u8 sText_NegateUnaware[] = _("Unkenntnis ignorieren");
static const u8 sText_WillSuicide[] = _("Setzt Selbst-KO ein");
static const u8 sText_PreferStatusMoves[] = _("Bevorzugt Statusattacken");
static const u8 sText_Stall[] = _("Verzögern");
static const u8 sText_SmartSwitching[] = _("Cleveres Wechseln");
static const u8 sText_AcePokemon[] = _("Top-Pokémon");
static const u8 sText_Omniscient[] = _("Allwissend");
static const u8 sText_SmartMonChoices[] = _("Cleveres Team");
static const u8 sText_Conservative[] = _("Vorsichtig");
static const u8 sText_SequenceSwitching[] = _("Reihenfolge-Wechsel");
static const u8 sText_DoubleAcePokemon[] = _("Doppelte Top-Pokémon");
static const u8 sText_WeighAbilityPrediction[] = _("Fähigkeiten abschätzen");
static const u8 sText_PreferHighestDamageMove[] = _("Max. Schaden bevorzugt");
static const u8 sText_PredictSwitch[] = _("Wechsel vorhersagen");
static const u8 sText_PredictIncomingMon[] = _("Kommendes Pokémon vorhersagen");
static const u8 sText_DynamicFunc[] = _("Dynamisch");
static const u8 sText_Roaming[] = _("Streifend");
static const u8 sText_Safari[] = _("Safari");
static const u8 sText_FirstBattle[] = _("Erster Kampf");
static const u8 sText_ShowHP[] = _("KP anzeigen");
static const u8 sText_SubstituteHp[] = _("Delegator-KP");
static const u8 sText_InLove[] = _("Verliebt");
static const u8 sText_Unknown[] = _("Unbekannt");
static const u8 sText_EmptyString[] = _("");
static const u8 sText_IsSwitching[] = _("Wechselt zu ");
