...
static const u8 sText_SpaceMove[] = _(" MOVE"); // Unverwendet
...
static const u8 sText_IsThisTradeOkay[] = _("Ist dieser Tausch in Ordnung?");
...
static const u8 sJPText_PressBButtonToQuit[] = _("Mit B-Knopf zurück");
static const u8 sText_Summary2[] = _("BERICHT");
static const u8 sText_Trade2[] = _("TAUSCH");
static const u8 sText_CommunicationStandby[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Verbindung wird hergestellt…\nBitte warten.");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Der Tausch wurde\nabgebrochen.");
static const u8 sText_OnlyPkmnForBattle[] = _("Das ist dein einziges\nkampfbereites POKéMON.");
static const u8 sText_WaitingForYourFriend[] = _("{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}Warte auf deinen Freund…");
