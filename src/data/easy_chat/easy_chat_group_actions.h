...
const u8 gEasyChatWord_Concede[]    = _("AUFGEBEN");
...
const u8 gEasyChatWord_Walking[]    = _("GEHT");
const u8 gEasyChatWord_Walks[]      = _("GEHT");
...
const u8 gEasyChatWord_Angers[]     = _("MACHT WÜTEND");
const u8 gEasyChatWord_Teach[]      = _("LEHREN");
const u8 gEasyChatWord_Teaches[]    = _("LEHRT");
const u8 gEasyChatWord_Please[]     = _("BITTE");
const u8 gEasyChatWord_Learn[]      = _("LERNEN");
const u8 gEasyChatWord_Change[]     = _("ÄNDERN");
const u8 gEasyChatWord_Story[]      = _("GESCHICHTE");
const u8 gEasyChatWord_Trust[]      = _("VERTRAUEN");
const u8 gEasyChatWord_Lavish[]     = _("ÜPPIG");
const u8 gEasyChatWord_Listens[]    = _("HÖRT ZU");
const u8 gEasyChatWord_Hearing[]    = _("HÖREN");
...
const u8 gEasyChatWord_Cause[]      = _("VERURSACHEN");
const u8 gEasyChatWord_Know[]       = _("WISSEN");
const u8 gEasyChatWord_Knows[]      = _("WEISS");
const u8 gEasyChatWord_Refuse[]     = _("ABLEHNEN");
const u8 gEasyChatWord_Stores[]     = _("LAGERT");
const u8 gEasyChatWord_Brag[]       = _("ANGEBEN");
const u8 gEasyChatWord_Ignorant[]   = _("UNWISSEND");
const u8 gEasyChatWord_Thinks[]     = _("DENKT");
const u8 gEasyChatWord_Believe[]    = _("GLAUBEN");
const u8 gEasyChatWord_Slide[]      = _("RUTSCHEN");
const u8 gEasyChatWord_Eats[]       = _("ISST");
const u8 gEasyChatWord_Use[]        = _("BENUTZEN");
const u8 gEasyChatWord_Uses[]       = _("BENUTZT");
const u8 gEasyChatWord_Using[]      = _("BENUTZT GERADE");
const u8 gEasyChatWord_Couldnt[]    = _("KONNTE NICHT");
const u8 gEasyChatWord_Capable[]    = _("FÄHIG");
const u8 gEasyChatWord_Disappear[]  = _("VERSCHWINDEN");
const u8 gEasyChatWord_Appear[]     = _("ERSCHEINEN");
const u8 gEasyChatWord_Throw[]      = _("WERFEN");
const u8 gEasyChatWord_Worry[]      = _("SORGEN");
const u8 gEasyChatWord_Slept[]      = _("SCHLIEF");
const u8 gEasyChatWord_Sleep[]      = _("SCHLAFEN");
const u8 gEasyChatWord_Release[]    = _("FREILASSEN");
const u8 gEasyChatWord_Drinks[]     = _("TRINKT");
const u8 gEasyChatWord_Runs[]       = _("RENNT");
const u8 gEasyChatWord_Run[]        = _("LAUFEN");
const u8 gEasyChatWord_Works[]      = _("ARBEITET");
const u8 gEasyChatWord_Working[]    = _("ARBEITET GERADE");
const u8 gEasyChatWord_Talking[]    = _("SPRECHEN");
const u8 gEasyChatWord_Talk[]       = _("REDE");
const u8 gEasyChatWord_Sink[]       = _("VERSINKEN");
const u8 gEasyChatWord_Smack[]      = _("SCHLAG");
const u8 gEasyChatWord_Pretend[]    = _("SO TUN ALS OB");
const u8 gEasyChatWord_Praise[]     = _("LOBE");
const u8 gEasyChatWord_Overdo[]     = _("ÜBERTREIBEN");
const u8 gEasyChatWord_Show[]       = _("ZEIGEN");
const u8 gEasyChatWord_Looks[]      = _("SIEHT AUS");
const u8 gEasyChatWord_Sees[]       = _("SIEHT");
const u8 gEasyChatWord_Seek[]       = _("SUCHEN");
const u8 gEasyChatWord_Own[]        = _("BESITZEN");
const u8 gEasyChatWord_Take[]       = _("NEHMEN");
...
const u8 gEasyChatWord_Faint[]      = _("Ohnmacht");
const u8 gEasyChatWord_Fainted[]    = _("WURDE BEZWUNGEN");
