...
const u8 gEasyChatWord_Gotcha[]         = _("ERWISCHT");
const u8 gEasyChatWord_Trade[]          = _("TAUSCH");
const u8 gEasyChatWord_Sapphire[]       = _("SAPHIR");
const u8 gEasyChatWord_Evolve[]         = _("ENTWICKLUNG");
...
const u8 gEasyChatWord_SpAbility[]      = _("SPEZ.FÄHIGK.");
...
const u8 gEasyChatWord_Get[]            = _("HOLEN");
