...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_NO_POKEMON] = COMPOUND_STRING("Du hast kein POKéMON."),
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_SWITCH] = {COMPOUND_STRING("TAUSCHEN"), CursorCb_Switch},
    ...
    [MENU_SHIFT] = {COMPOUND_STRING("WECHSELN"), CursorCb_SendMon},
    [MENU_SEND_OUT] = {COMPOUND_STRING("AUSSENDEN"), CursorCb_SendMon},
    [MENU_ENTER] = {COMPOUND_STRING("EINTRITT"), CursorCb_Enter},
    [MENU_NO_ENTRY] = {COMPOUND_STRING("KEIN EINTRITT"), CursorCb_NoEntry},
    ...
    [MENU_CATALOG_BULB] = {COMPOUND_STRING("GLÜHBIRNE"), CursorCb_CatalogBulb},
    [MENU_CATALOG_OVEN] = {COMPOUND_STRING("MIKROWELLE"), CursorCb_CatalogOven},
    [MENU_CATALOG_WASHING] = {COMPOUND_STRING("WASCHMASCHINE"), CursorCb_CatalogWashing},
    ...
    [MENU_CHANGE_ABILITY] = {COMPOUND_STRING("FÄHIGK. WECHSELN"), CursorCb_ChangeAbility},
};
